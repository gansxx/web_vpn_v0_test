...
// 无限流量套餐购买请求
export interface UnlimitedPlanPurchaseRequest {
  phone?: string
  plan_id?: string
  plan_name: string
...
// 无限流量套餐购买响应
export interface UnlimitedPlanPurchaseResponse {
  success: boolean
  message: string
  order_id?: string
...
// 无限流量套餐状态检查响应
export interface UnlimitedPlanStatusResponse {
  has_unlimited_plan: boolean
  unlimited_plans: Array<{
    id: string
    product_name: string
