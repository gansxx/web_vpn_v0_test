    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      >
        ...
        <nav className="mt-8 px-4 space-y-2">
          <a
            href="#"
            className="flex items-center space-x-3 px-4 py-3 text-gray-700 rounded-lg bg-blue-50 text-blue-600"
          >
      ...
      <div className="flex-1 lg:ml-0">
        ...
        <div className="fixed bottom-6 right-6">
          <button className="bg-blue-600 text-white p-4 rounded-full shadow-lg hover:bg-blue-700 transition-colors flex items-center space-x-2">
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
